...
public class BoardController {
	...
	public String userReviewform(HttpServletRequest req, @RequestParam
									int h_num, int room_num, int book_num) {
...
//		같은 날에 해당 유저가 쓴 리뷰가 있는지 확인하고 있으면 바로 리스트로 보냄
		...
		List<ReviewDTO> reviewList = userMyPageMapper.getReviewList(Integer.parseInt(mr.getParameter("u_num")), Integer.parseInt(mr.getParameter("h_num")));
